...
app = Flask(__name__) #Se crea una instancia de la clase Flask y se le pasa __name_, que es una variable especial de Python que representa el nombre del módulo actual. 
...
def index():
    ...
    ax.set_title('Comparación entre Consumo de Energía Renovable y Convencionla',fontsize=12)
